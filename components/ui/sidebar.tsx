...
import { useIsMobile } from "@/components/layout/sidebar/use-mobile";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed top-[var(--announcement-banner-height,0px)] z-10 hidden h-[calc(100svh-var(--announcement-banner-height,0px))] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
function SidebarMenuSkeleton({
  ...
  const widthSeed = reactId
    .split("")
    .reduce((seed, char) => seed + char.charCodeAt(0), 0);
  const width = `${(widthSeed % 41) + 50}%`;
