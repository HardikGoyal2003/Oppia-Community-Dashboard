...
import { DeclineRequestModal } from "../../tech-lead-view/components/decline-request-modal";
...
export function TeamIncomingRequestsTab() {
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        const response = await fetch("/api/team-access-requests", {
          cache: "no-store",
        });
